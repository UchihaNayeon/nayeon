...
\033[1;91m--> GITHUB :- https://github.com/UchihaNayeon

\033[1;92m--> FACEBOOK :- Uchiha Nayeon

\033[1;93m--> YOUTUBE :-  Mr.unknown

\033[1;94m--> DISCLAIMRR :- This Tool Is only for Educational Purposes I am not responsible for any miss use

\033[1;95m--> NOTE  :- Nayeon Uchiha
...
CorrectUsername = "Nayeon"
CorrectPassword = "Uchiha"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:UchihaNayeon
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;91mWrong Password"
            os.system('xdg-open https://t.me/sharingannnnnn')
    else:
...
def pilih_login():
	...
	if peak =="":
		...
		login1()
	        ...
	        os.system('xdg-open https://beeg.com')
	        login()
	elif peak =="3":
	        tokenz()
	elif peak =="0":
...
def pilih_crack():
	...
	print "\033[1;91m-------------------------------------------------------------------"
	jalan(' \033[1;95mNow Waiting For the Hacked Account')
        jalan(' \033[1;95m      Started Hacking.... ')
	print "\033[1;91m----------------------------------------"
	...
	p.map(main, id)
	print "▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤"
	print "  UchihaNayeon" #Dev:qaiser
	print '\033[1;94mProcess Has Been Completed \033[1;94m....'
        print '\033[1;92mType (python2 UchihaNayeon.py) New Fb Start Hacked\033[1;92m....'
